...
<body class="bg-gray-200">
  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-image: url(<?= base_url('recursos/images/bg.jpg') ?>);">
      ...
      <div class="container my-auto">
        <div class="row">
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            ...
            <?php endif; ?>
                <form role="form" class="text-start" action="<?= base_url('usuarios/inicioSesion') ?>" method="post">
                  <div class="input-group input-group-outline my-3">
                    
                  <input type="text" class="form-control" name="nombre_usuario" value="<?= old('nombre_usuario') ?>" placeholder="Nombre de usuario" required>
                  </div>
                  ...
                  <a href="#" class="forgot-pw">¿Olvidaste la contraseña?</a>
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2">Iniciar Session</button>
                  </div>
                  <p class="mt-4 text-sm text-center">
                  ¿No tienes una cuenta?
                    <a href="<?= base_url('usuarios/register') ?>" class="text-primary text-gradient font-weight-bold">Regístrate</a>
                  </p>
                </form>
              </div>
            </div>
          ...
          <div class="row align-items-center justify-content-lg-between">
            ...
            <div class="col-12 col-md-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="https://www.creative-tim.com" class="nav-link text-white" target="_blank">Explora</a>
                </li>
                <li class="nav-item">
                  <a href="https://www.creative-tim.com/presentation" class="nav-link text-white" target="_blank">Acerca de nosotros</a>
                </li>
                <li class="nav-item">
