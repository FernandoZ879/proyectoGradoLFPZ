        ...
        <div class="container">
          <div class="row">
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center" style="background-image: url(<?= base_url('recursos/images/raMU.jpg') ?>); background-size: cover;">
              </div>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                <div class="card-header">
                  ...
                  <p class="mb-0">Ingresa su correo electronico y contraseña para registrarse</p>
                </div>
                <div class="card-body">
                  ...
                  <?php endif; ?>
                  <form role="form" action="<?= base_url('usuarios/registro') ?>" method="post">
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0">Registrate</button>
                    </div>
                  </form>
                </div>
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-2 text-sm mx-auto">
                    ...
                    <a href="<?= base_url('usuarios/login') ?>" class="text-primary text-gradient font-weight-bold">Inicia sesión</a>
                  </p>
                </div>
              </div>
            </div>
